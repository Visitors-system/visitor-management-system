...
const dashboardData = {
    ...
    admin: {
        ...
        visitorsTrends: {
            daily: [35, 42, 38, 45, 50, 25, 30], // المراجعين اليومي (أيام الأسبوع)
            hourly: [5, 8, 12, 15, 20, 25, 18, 15, 10, 8, 6, 4] // المراجعين حسب الساعة (8 صباحًا - 8 مساءً)
        }
    }
};
...
// دالة لجلب اتجاهات المراجعين للإدارة العليا
